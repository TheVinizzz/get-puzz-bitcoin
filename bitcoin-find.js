...
export async function encontrarBitcoinsRandom(key, min, max, shouldStop, size){
        ...
        while(!shouldStop()){
            ...
            if (Date.now() - startTime > segundos){
                ...
                if (segundos % 10000 == 0){
                    ...
                    console.log('Resumo: ')
                    console.log('Velocidade:', (Number(key) - Number(min))/ tempo, ' chaves por segundo')
                    console.log('Chaves buscadas: ', (tentativas).toLocaleString('pt-BR'));    
                    console.log('Ultima chave tentada: ',pkey )
